...
### 배경
SDLClaude.md 내용을 설명하는 README.md를 작성한다.
IDECommand.png, ShortCut.png 내용을 포함한다.

### 할 일

- [x] SDLClaude.md에 영어 작성 규칙 추가
- [x] README.md 작성 (영어)
  - [x] SDLClaude.md 내용 요약 및 설명
...
### 배경
사용자가 Concept.md에 SDLClaude 개선 아이디어(ECC에서 선별 흡수할
...
## SDLClaude Improvement Track (from Concept.md)

### Background
Concept.md proposes seven incremental improvements adopted selectively
from ECC to strengthen SDLClaude while preserving its minimalist
...
1. Fix broken `SDLClaude.md` self-references (file does not exist).
